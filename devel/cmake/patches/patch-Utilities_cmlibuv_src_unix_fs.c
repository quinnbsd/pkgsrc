...
--- Utilities/cmlibuv/src/unix/fs.c.orig	2021-01-28 15:28:45.000000000 +0000
...
@@ -1032,7 +1032,7 @@ static ssize_t uv__fs_utime(uv_fs_t* req
     || defined(__FreeBSD__)                                                   \
     || defined(__FreeBSD_kernel__)                                            \
     || defined(__NetBSD__)                                                    \
-    || defined(__OpenBSD__)
+    || defined(__OpenBSD__) || defined(__QuinnBSD__)
   ...
   tv[0] = uv__fs_to_timeval(req->atime);
   tv[1] = uv__fs_to_timeval(req->mtime);
@@ -1071,7 +1071,7 @@ static ssize_t uv__fs_lutime(uv_fs_t* re
       defined(__DragonFly__)      ||                                          \
       defined(__FreeBSD__)        ||                                          \
       defined(__FreeBSD_kernel__) ||                                          \
-      defined(__NetBSD__)
+      defined(__NetBSD__) || defined(__QuinnBSD__)
   ...
   tv[0] = uv__fs_to_timeval(req->atime);
   tv[1] = uv__fs_to_timeval(req->mtime);
@@ -1359,7 +1359,7 @@ static void uv__to_stat(struct stat* src
     defined(_BSD_SOURCE)     || \
...
@@ -1367,7 +1367,7 @@ static void uv__to_stat(struct stat* src
